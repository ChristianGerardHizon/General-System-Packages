...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, collectionId: $collectionId, collectionName: $collectionName, created: $created, updated: $updated, name: $name, description: $description, isPublic: $isPublic)';
  }
...
abstract class _Service implements Service {
  const factory _Service(
      ...
      @JsonKey(name: 'isPublic', fromJson: JsonParser.boolFromJson)
          required final bool isPublic}) = _$_Service;
